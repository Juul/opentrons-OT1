...
class SquirrelWindowsTarget extends (_electronBuilder || _load_electronBuilder()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            (0, (_log || _load_log()).log)(`Building Squirrel.Windows for arch ${(_electronBuilder || _load_electronBuilder()).Arch[arch]}`);
    ...
    computeEffectiveDistOptions() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const options = Object.assign({
                ...
                vendorPath: yield (0, (_binDownload || _load_binDownload()).getBinFromGithub)("Squirrel.Windows", SW_VERSION, SW_SHA2)
            }, _this2.options);
