  ...
  buildInstaller() {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      yield packager.info.callArtifactBuildStarted({
        targetPresentableName: _this4.name,
        file: installerPath,
        arch: null
      }, logFields);
        ...
        function () {
          var _ref = (0, _bluebirdLst().coroutine)(function* (arch) {
            ...
            if (_this4.isWebInstaller) {
              yield packager.dispatchArtifactCreated(file, _this4, arch);
      ...
      if (isPortable) {
        ...
        defines.UNPACK_DIR_NAME = yield (0, _builderUtil().executeAppBuilder)(["ksuid"]);
      } else {
